 ...
 * (Lenis-smoothed) vertical scroll, with a subtle parallax on each panel's
 * image. Isolated here so JourneySection stays presentational and the GSAP
 * dependency never leaks beyond this hook.
 */
